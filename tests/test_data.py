...
class TestData:
    ...
    def test_serialize_configuration(self, config_service, test_config, temp_file):
        """Test serialization and deserialization of Configuration."""
